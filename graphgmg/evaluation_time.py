...
def compute_kld_all(generate_graph_list, real_graph_list, test_size=800):
    ...
    result.append(('temporal', compute_kld('temporal', generate_graph_list, real_graph_list, test_size)))
    result.append(('between', compute_kld('between', generate_graph_list, real_graph_list, test_size)))
    # result.append(('close', compute_kld('close', generate_graph_list, real_graph_list, test_size)))
    print(result)
