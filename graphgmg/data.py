...
def Graph_load_batch(min_num_nodes=20, max_num_nodes=1000, name='ENZYMES', node_attributes=True, graph_labels=True, extra_path_prefix=''):
    """
    ...
    G = nx.Graph()
    # load data
    path = extra_path_prefix + 'dataset/' + name + '/'
